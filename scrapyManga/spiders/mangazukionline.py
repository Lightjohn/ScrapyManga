...
class MangaReaderSpider(CliSpider):
    ...
    def parse(self, response):
        all_chapters = response.xpath('//select[@class="selectpicker single-chapter-select"]//@data-redirect')
        ...
        for url_chapter in all_chapters:
            ...
            yield scrapy.Request(url=clean_url, callback=self.parse_chapter, meta=meta, dont_filter=True)
